        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedEntityType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false, defaultValue: "Unspecified"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedValueCurrency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "VND"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProposerListingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReceiverListingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exchanges_Listings_ProposerListingId",
                        column: x => x.ProposerListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Exchanges_Listings_ReceiverListingId",
                        column: x => x.ReceiverListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Exchanges_Users_ProposerId",
            ...
            migrationBuilder.CreateTable(
                name: "MatchingHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SourceListingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MatchedListingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchingHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MatchingHistories_Listings_MatchedListingId",
                        column: x => x.MatchedListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MatchingHistories_Listings_SourceListingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountCurrency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "VND"),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "Pending"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedExchangeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversations_Exchanges_RelatedExchangeId",
                        column: x => x.RelatedExchangeId,
                        principalTable: "Exchanges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Conversations_Listings_RelatedListingId",
                        column: x => x.RelatedListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), "Standard user with basic listing limits", "Member" },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), "Administrator with full access", "Admin" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_RelatedListingId",
                table: "Conversations",
                column: "RelatedListingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exchanges_ProposerId",
                table: "Exchanges",
                column: "ProposerId");

            migrationBuilder.CreateIndex(
                name: "IX_Exchanges_ProposerListingId",
                table: "Exchanges",
                column: "ProposerListingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exchanges_ReceiverListingId",
                table: "Exchanges",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_User_Listing",
                table: "Favorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchingHistories_MatchedListingId",
                table: "MatchingHistories",
                column: "MatchedListingId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchingHistories_SourceListingId",
                table: "MatchingHistories",
                column: "SourceListingId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchingHistories_SourceListingId_IsAccepted",
                table: "MatchingHistories",
                columns: new[] { "SourceListingId", "IsAccepted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_Exchange_Reviewer",
                table: "Reviews",
                columns: new[] { "ExchangeId", "ReviewerId" },
                unique: true);
